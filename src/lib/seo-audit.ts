// Lightweight technical + on-page SEO audit: fetches a single page and runs
// deterministic checks against it. No external SEO API/paid tool — just the
// same "fetch the HTML and read it" approach as website-scan.ts, extended
// with the checks that actually matter for a small local-business site.
// Findings follow Issue / Impact / Evidence / Fix so they read like a real
// audit, not just a pass/fail list.
